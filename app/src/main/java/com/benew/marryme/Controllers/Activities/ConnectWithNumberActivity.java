...
public class ConnectWithNumberActivity extends BaseActivity {
    ...
    @Override
    protected int getLayout() { return R.layout.activity_connect_with_number; }
        ...
        getUserDocumentReference(numberUser).get().addOnCompleteListener(task -> {
            ...
            if (documentSnapshot.exists()) {
                ...
                if (result.verified) {
                    ...
                    startActivity(new Intent(ConnectWithNumberActivity.this, NoyauActivity.class));
                } else
                    Toasty.info(ConnectWithNumberActivity.this, WRONG_PASSWORD).show();
                ...
                getUserDocumentReference(numberUser).set(newUserMap).addOnSuccessListener(aVoid -> {
                    ...
                    startActivity(new Intent(ConnectWithNumberActivity.this, InfoGeneralActivity.class));
                    toast.hide();
                });
            }
        });
